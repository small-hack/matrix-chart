...
![Version: 7.0.1](https://img.shields.io/badge/Version-7.0.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.102.0](https://img.shields.io/badge/AppVersion-v1.102.0-informational?style=flat-square)
...
| element.image.tag | string | `"v1.11.61"` | tag to use for element docker image |
