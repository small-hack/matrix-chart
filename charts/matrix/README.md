...
![Version: 21.6.0](https://img.shields.io/badge/Version-21.6.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.144.0](https://img.shields.io/badge/AppVersion-v1.144.0-informational?style=flat-square)
...
| https://small-hack.github.io/matrix-authentication-service-chart | mas(matrix-authentication-service) | 2.1.0 |
...
| bridges.hookshot.image.tag | string | `"7.3.0"` | hookshot bridge docker image tag |
