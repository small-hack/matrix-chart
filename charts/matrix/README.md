...
![Version: 19.4.1](https://img.shields.io/badge/Version-19.4.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.127.1](https://img.shields.io/badge/AppVersion-v1.127.1-informational?style=flat-square)
...
| element.image.tag | string | `"v1.11.97"` | tag to use for element docker image |
